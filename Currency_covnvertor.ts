...
let userFromCurrency = user_answer.FromCurrency
let userToCurrency = user_answer.ToCurrency

let fromAmount = currecyRate[userFromCurrency]
let ToAmount = currecyRate[userToCurrency]
